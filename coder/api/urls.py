...
from .views import ProfileDetailView,ProfileCustomerView, ProfileBusinessView, OfferView,OfferDetailView,OfferDetailRetrieveView,OrderView,OrderDetailView,BusinessUserOrderCountView,BusinessUserOrderCompletedCountView,ReviewCreateView,ReviewDetailView
